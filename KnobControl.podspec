...
Pod::Spec.new do |s|
  ...
  s.name         = "KnobControl"
  s.version      = "1.0.1"
  s.summary      = "Terry summary A knob control like the UISlider, but in a circular form."
  ...
  s.author             = { "anson" => "anson@gmail.com" }
  # Or just: s.author    = "anson"
  # s.authors            = { "anson" => "anson@gmail.com" }
  # s.social_media_url   = "http://twitter.com/anson"
  ...
  # s.source       = { :path => "." }
  s.source       = { :git => "https://github.com/chung2014/KnobControl2.git", :tag => "1.0.1" }
